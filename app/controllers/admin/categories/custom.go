...
func GetAllCategories(g *gin.Context) {
	...
	response["data"] = transformers.CategoriesResponse(rows, true)
	// transform slice
...
/***
* get all rows with status
 */
func Status(g *gin.Context) {
	// return response
	helpers.OkResponse(helpers.DoneGetAllItems(), transformers.ActionsResponse(models.GetActionByModule(models.CategoryRoute())))
}
